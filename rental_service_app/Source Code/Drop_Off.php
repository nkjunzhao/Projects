...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($_POST['Reservation_id']) or !isset($_POST['Reservation_id'])) {
	    ...
	    header('Location: Drop_Off_Update_to_DB.php?Reservation_id=' . $_POST['Reservation_id']);
	    exit();
	}	
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		<title>Handyman Reservation Drop Off Step 1</title>
		...
		<div id="main_container">
			...
			<div class="center_content">
				...
				<div class="text_box">
					...
					<form action="Drop_Off.php" method="post">
				  
						<div class="title">Handyman Reservation Drop Off Step 1</div>
